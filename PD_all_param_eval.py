...
def solve_one_instance(param, save_path_root, bigM, thread):
    ...
    # ------------------
    num_WT = 2 # the number of wind turbines
...
def run_all_param():
    ...
    num_gen_list = [2]  # the number of thermal generators. 38 is the number of lines for case24_ieee_rts
